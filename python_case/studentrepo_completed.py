...
path = r"C:\Users\Purushotham\Desktop\oracle\day_05\case\students.csv"
f = open(path)
content  = f.readlines()
f.close()
...
for regid in classdict.keys():
    ...
    for sub in ['phy', 'chem', 'math', 'bio']:
        sum_of_subj_marks += float(classdict[regid][sub])
...
path = r"C:\Users\Purushotham\Desktop\oracle\day_05\case\students_completed.csv"
f = open(path, "w")
f.write(coldata)
